...
PROMPT_FRAGMENTS: dict[str, dict[str, Any]] = {
    ...
    "mcp_webplayer_call_templates": {
        ...
        "instructions": [
            ...
            "Then use tools/call with one of: webplayer_play, webplayer_search_play, webplayer_playlist_play, webplayer_library_play, webplayer_open_playback_target, webplayer_favorite_current_track, webplayer_volume_adjust, webplayer_stop, webplayer_forward, webplayer_backward, webplayer_now_playing, webplayer_search, tidal_api_request, tidal_api_track, tidal_api_track_manifest, tidal_api_widevine.",
            "Prefer webplayer_search_play, webplayer_playlist_play, webplayer_library_play, or webplayer_open_playback_target for playback start; keep webplayer_play as a retry fallback. Use webplayer_favorite_current_track to heart/save the active track and webplayer_volume_adjust for volume changes.",
            ...
            "FAVORITE: {'endpoint':'http://127.0.0.1:8766/mcp','method':'POST','payload':'{\"method\":\"tools/call\",\"params\":{\"name\":\"webplayer_favorite_current_track\",\"arguments\":{\"player_selector\":\"chromium\",\"wait_for_player_s\":2}}}'}",
            "VOLUME_UP: {'endpoint':'http://127.0.0.1:8766/mcp','method':'POST','payload':'{\"method\":\"tools/call\",\"params\":{\"name\":\"webplayer_volume_adjust\",\"arguments\":{\"player_selector\":\"chromium\",\"delta_percent\":5}}}'}",
            "VOLUME_DOWN: {'endpoint':'http://127.0.0.1:8766/mcp','method':'POST','payload':'{\"method\":\"tools/call\",\"params\":{\"name\":\"webplayer_volume_adjust\",\"arguments\":{\"player_selector\":\"chromium\",\"delta_percent\":-5}}}'}",
