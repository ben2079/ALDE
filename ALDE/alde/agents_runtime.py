...
PROMPT_FRAGMENTS: dict[str, dict[str, Any]] = {
    ...
    "mcp_webplayer_call_templates": {
        ...
        "instructions": [
            ...
            "Then use tools/call with one of: webplayer_play, webplayer_search_play, webplayer_playlist_play, webplayer_library_play, webplayer_open_playback_target, webplayer_stop, webplayer_forward, webplayer_backward, webplayer_volume, webplayer_now_playing, webplayer_search, tidal_api_request, tidal_api_track, tidal_api_track_manifest, tidal_api_widevine.",
            ...
            "VOLUME: {'endpoint':'http://127.0.0.1:8766/mcp','method':'POST','payload':'{\"method\":\"tools/call\",\"params\":{\"name\":\"webplayer_volume\",\"arguments\":{\"player_selector\":\"chromium\",\"delta_percent\":10}}}'}",
